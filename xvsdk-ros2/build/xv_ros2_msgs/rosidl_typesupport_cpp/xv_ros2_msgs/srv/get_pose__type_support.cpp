...
static const _GetPose_Request_type_support_symbol_names_t _GetPose_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xv_ros2_msgs, srv, GetPose_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xv_ros2_msgs, srv, GetPose_Request)),
  }
};
...
{
  return &::xv_ros2_msgs::srv::rosidl_typesupport_cpp::GetPose_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, xv_ros2_msgs, srv, GetPose_Request)() {
  return get_message_type_support_handle<xv_ros2_msgs::srv::GetPose_Request>();
}
...
static const _GetPose_Response_type_support_symbol_names_t _GetPose_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xv_ros2_msgs, srv, GetPose_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xv_ros2_msgs, srv, GetPose_Response)),
  }
};
...
{
  return &::xv_ros2_msgs::srv::rosidl_typesupport_cpp::GetPose_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, xv_ros2_msgs, srv, GetPose_Response)() {
  return get_message_type_support_handle<xv_ros2_msgs::srv::GetPose_Response>();
}
...
static const _GetPose_type_support_symbol_names_t _GetPose_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xv_ros2_msgs, srv, GetPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xv_ros2_msgs, srv, GetPose)),
  }
};
...
{
  return &::xv_ros2_msgs::srv::rosidl_typesupport_cpp::GetPose_service_type_support_handle;
}
