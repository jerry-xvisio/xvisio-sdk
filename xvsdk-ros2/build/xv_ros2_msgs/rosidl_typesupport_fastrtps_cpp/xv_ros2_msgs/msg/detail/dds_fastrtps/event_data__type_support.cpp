...
#include "xv_ros2_msgs/msg/detail/event_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const xv_ros2_msgs::msg::EventData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  xv_ros2_msgs::msg::EventData & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = xv_ros2_msgs::msg::EventData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const xv_ros2_msgs::msg::EventData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<xv_ros2_msgs::msg::EventData *>(
    untyped_ros_message);
...
{
  return &xv_ros2_msgs::msg::typesupport_fastrtps_cpp::_EventData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xv_ros2_msgs, msg, EventData)() {
  return &xv_ros2_msgs::msg::typesupport_fastrtps_cpp::_EventData__handle;
}
