...
#include "xv_ros2_msgs/srv/detail/get_orientation__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = xv_ros2_msgs::srv::GetOrientation_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const xv_ros2_msgs::srv::GetOrientation_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<xv_ros2_msgs::srv::GetOrientation_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetOrientation_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const xv_ros2_msgs::srv::GetOrientation_Request *>(
...
static size_t _GetOrientation_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetOrientation_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetOrientation_Request__callbacks = {
  "xv_ros2_msgs::srv",
...
static rosidl_message_type_support_t _GetOrientation_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetOrientation_Request__callbacks,
...
{
  return &xv_ros2_msgs::srv::typesupport_fastrtps_cpp::_GetOrientation_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = xv_ros2_msgs::srv::GetOrientation_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const xv_ros2_msgs::srv::GetOrientation_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<xv_ros2_msgs::srv::GetOrientation_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetOrientation_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const xv_ros2_msgs::srv::GetOrientation_Response *>(
...
static size_t _GetOrientation_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetOrientation_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetOrientation_Response__callbacks = {
  "xv_ros2_msgs::srv",
...
static rosidl_message_type_support_t _GetOrientation_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetOrientation_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &xv_ros2_msgs::srv::typesupport_fastrtps_cpp::_GetOrientation_Response__handle;
}
...
static service_type_support_callbacks_t _GetOrientation__callbacks = {
  "xv_ros2_msgs::srv",
  "GetOrientation",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xv_ros2_msgs, srv, GetOrientation_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xv_ros2_msgs, srv, GetOrientation_Response)(),
...
static rosidl_service_type_support_t _GetOrientation__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetOrientation__callbacks,
...
{
  return &xv_ros2_msgs::srv::typesupport_fastrtps_cpp::_GetOrientation__handle;
}
