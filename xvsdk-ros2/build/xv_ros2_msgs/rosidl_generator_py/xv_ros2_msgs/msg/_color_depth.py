...
class Metaclass_ColorDepth(type):
    """Metaclass of message 'ColorDepth'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'xv_ros2_msgs.msg.ColorDepth')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__color_depth
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__color_depth
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__color_depth
            cls._TYPE_SUPPORT = module.type_support_msg__msg__color_depth
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__color_depth
...
class ColorDepth(metaclass=Metaclass_ColorDepth):
    """Message class 'ColorDepth'."""
