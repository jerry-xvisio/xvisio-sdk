...
#include "xv_ros2_msgs/msg/detail/controller__rosidl_typesupport_fastrtps_c.h"
...
using _Controller__ros_msg_type = xv_ros2_msgs__msg__Controller;
...
size_t get_serialized_size_xv_ros2_msgs__msg__Controller(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Controller__ros_msg_type * ros_message = static_cast<const _Controller__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Controller__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_xv_ros2_msgs__msg__Controller(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xv_ros2_msgs
size_t max_serialized_size_xv_ros2_msgs__msg__Controller(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = xv_ros2_msgs__msg__Controller;
    is_plain =
      (
...
static size_t _Controller__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_xv_ros2_msgs__msg__Controller(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xv_ros2_msgs, msg, Controller)() {
