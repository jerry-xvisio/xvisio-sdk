...
#include "xv_ros2_msgs/msg/detail/orientation_stamped__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // angular_velocity
...
using _OrientationStamped__ros_msg_type = xv_ros2_msgs__msg__OrientationStamped;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _OrientationStamped__ros_msg_type * ros_message = static_cast<const _OrientationStamped__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _OrientationStamped__ros_msg_type * ros_message = static_cast<_OrientationStamped__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _OrientationStamped__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_xv_ros2_msgs__msg__OrientationStamped(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = xv_ros2_msgs__msg__OrientationStamped;
    is_plain =
      (
...
static size_t _OrientationStamped__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_xv_ros2_msgs__msg__OrientationStamped(
...
static message_type_support_callbacks_t __callbacks_OrientationStamped = {
  "xv_ros2_msgs::msg",
  "OrientationStamped",
...
static rosidl_message_type_support_t _OrientationStamped__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_OrientationStamped,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xv_ros2_msgs, msg, OrientationStamped)() {
  return &_OrientationStamped__type_support;
}
