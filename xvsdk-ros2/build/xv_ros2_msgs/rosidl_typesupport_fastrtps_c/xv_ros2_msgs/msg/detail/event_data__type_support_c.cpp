...
#include "xv_ros2_msgs/msg/detail/event_data__rosidl_typesupport_fastrtps_c.h"
...
using _EventData__ros_msg_type = xv_ros2_msgs__msg__EventData;
...
size_t get_serialized_size_xv_ros2_msgs__msg__EventData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _EventData__ros_msg_type * ros_message = static_cast<const _EventData__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _EventData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_xv_ros2_msgs__msg__EventData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xv_ros2_msgs
size_t max_serialized_size_xv_ros2_msgs__msg__EventData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = xv_ros2_msgs__msg__EventData;
    is_plain =
      (
...
static size_t _EventData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_xv_ros2_msgs__msg__EventData(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xv_ros2_msgs, msg, EventData)() {
