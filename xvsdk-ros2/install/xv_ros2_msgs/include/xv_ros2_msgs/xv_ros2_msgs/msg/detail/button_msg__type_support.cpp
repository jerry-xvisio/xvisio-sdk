...
{
  new (message_memory) xv_ros2_msgs::msg::ButtonMsg(_init);
}

void ButtonMsg_fini_function(void * message_memory)
{
  auto typed_message = static_cast<xv_ros2_msgs::msg::ButtonMsg *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ButtonMsg_message_member_array[2] = {
  {
    ...
    offsetof(xv_ros2_msgs::msg::ButtonMsg, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(xv_ros2_msgs::msg::ButtonMsg, state),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ButtonMsg_message_members = {
  ...
  2,  // number of fields
  sizeof(xv_ros2_msgs::msg::ButtonMsg),
...
{
  return &::xv_ros2_msgs::msg::rosidl_typesupport_introspection_cpp::ButtonMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xv_ros2_msgs, msg, ButtonMsg)() {
  return &::xv_ros2_msgs::msg::rosidl_typesupport_introspection_cpp::ButtonMsg_message_type_support_handle;
}
