...
bool xv_ros2_msgs__msg__orientation_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("xv_ros2_msgs.msg._orientation_stamped.OrientationStamped", full_classname_dest, 56) == 0);
  }
  xv_ros2_msgs__msg__OrientationStamped * ros_message = _ros_message;
  {  // header
  ...
  {  // matrix
    ...
    }
    {
      ...
      Py_ssize_t size = 9;
      double * dest = ros_message->matrix;
...
{
  /* NOTE(esteve): Call constructor of OrientationStamped */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("xv_ros2_msgs.msg._orientation_stamped");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "OrientationStamped");
  ...
  {  // matrix
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "matrix");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    double * src = &(ros_message->matrix[0]);
