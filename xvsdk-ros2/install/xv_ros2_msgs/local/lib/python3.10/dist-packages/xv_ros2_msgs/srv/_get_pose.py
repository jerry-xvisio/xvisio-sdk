...
class Metaclass_GetPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from xv_ros2_msgs.srv import _get_pose
...
class GetPose(metaclass=Metaclass_GetPose):
    from xv_ros2_msgs.srv._get_pose import GetPose_Request as Request
    from xv_ros2_msgs.srv._get_pose import GetPose_Response as Response
