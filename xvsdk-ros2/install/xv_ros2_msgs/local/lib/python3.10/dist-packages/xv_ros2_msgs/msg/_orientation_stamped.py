...
class Metaclass_OrientationStamped(type):
    """Metaclass of message 'OrientationStamped'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__orientation_stamped
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__orientation_stamped
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__orientation_stamped
            cls._TYPE_SUPPORT = module.type_support_msg__msg__orientation_stamped
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__orientation_stamped
...
class OrientationStamped(metaclass=Metaclass_OrientationStamped):
    """Message class 'OrientationStamped'."""
    ...
    def __init__(self, **kwargs):
        ...
        if 'matrix' not in kwargs:
            self.matrix = numpy.zeros(9, dtype=numpy.float64)
        else:
            self.matrix = numpy.array(kwargs.get('matrix'), dtype=numpy.float64)
            assert self.matrix.shape == (9, )
        from geometry_msgs.msg import Quaternion
    ...
    def __eq__(self, other):
        ...
        if self.header != other.header:
            return False
        if all(self.matrix != other.matrix):
            return False
    ...
    def matrix(self, value):
        if isinstance(value, numpy.ndarray):
            assert value.dtype == numpy.float64, \
                "The 'matrix' numpy.ndarray() must have the dtype of 'numpy.float64'"
            assert value.size == 9, \
                "The 'matrix' numpy.ndarray() must have a size of 9"
            self._matrix = value
            return
        if __debug__:
        ...
        self._matrix = numpy.array(value, dtype=numpy.float64)
